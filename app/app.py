...
with open(r'C:\Users\Barath kumar\OneDrive\Desktop\GUVI\Mini Project\MDP\pkl\pkn_model.pkl',"rb") as file:
    parkinson_model=pickle.load(file)

with open(r'C:\Users\Barath kumar\OneDrive\Desktop\GUVI\Mini Project\MDP\pkl\lvr_model.pkl',"rb") as file:
    liver_model=pickle.load(file)

with open(r'C:\Users\Barath kumar\OneDrive\Desktop\GUVI\Mini Project\MDP\pkl\ckd_model.pkl',"rb") as file:
